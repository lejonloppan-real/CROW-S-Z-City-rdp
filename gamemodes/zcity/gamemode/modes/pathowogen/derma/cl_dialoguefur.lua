...
local COMMANDER_DEFAULT = Material("zbattle/FURMANDER.png", "smooth")
local function loadCommanderApril()
	local mat = Material("custom/Bart", "smooth")
	if not mat or mat:IsError() then
		mat = Material("custom/Bart.png", "smooth")
	end
	if not mat or mat:IsError() then
		mat = Material("custom/bart", "smooth")
	end
	if not mat or mat:IsError() then
		mat = Material("custom/bart.png", "smooth")
	end
