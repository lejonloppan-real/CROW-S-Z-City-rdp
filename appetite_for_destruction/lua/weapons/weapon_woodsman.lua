...
SWEP.Author = "Colt"
SWEP.Instructions = "КАЛИБР КОМАРИННЫЙ УКУС"
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_p99.mdl"
SWEP.WorldModelFake = "models/weapons/tacint_extras/v_woodsman.mdl"
//SWEP.FakeScale = 1.2
SWEP.FakePos = Vector(-18, 2.005, -1)
...
SWEP.LocalMuzzlePos = Vector(5.767,-1,1.1)
...
SWEP.Primary.Sound = {"tacint_extras/woodsman/p228-1.wav", 75, 90, 100}
