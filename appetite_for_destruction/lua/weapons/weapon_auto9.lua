...
SWEP.PrintName = "Auto9"
SWEP.Author = "OCP"
SWEP.Instructions = "The Auto 9 was a highly advanced select-fire machine pistol with a 50-round magazine. It was holstered in a concealed alcove in RoboCop's thigh, together with at least one reload magazine in storage. The most commonly utilized fire setting was in a three-round burst mode. Chambered in 9x19 mm."
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ava/w_auto9.mdl"

SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ava_auto9")
SWEP.IconOverride = "vgui/hud/tfa_ava_auto9"
...
SWEP.Primary.Sound = {"weapons/tfa_ava/auto9/shot.wav", 75, 90, 100}
...
SWEP.ReloadSoundes = {
	"none",
	"weapons/tfa_ava/auto9/magout.wav",
	"weapons/tfa_ava/auto9/magin.wav",
	"weapons/tfa_ava/auto9/sliderel.wav",
	"none",
	"none"
}
...
SWEP.ZoomPos = Vector(-26, -0.0054, 5.9)
...
SWEP.LocalMuzzlePos = Vector(16,0.1,4.3)
