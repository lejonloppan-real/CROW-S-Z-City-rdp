...
SWEP.PrintName = "Contender" -- сам ты дабл баррел
SWEP.Author = "Remington"
SWEP.Instructions = "Pistol for hunting. Chambered in  7.62x51 NATO"
...
SWEP.WepSelectIcon2 = Material("entities/arccw_contender.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/arccw_contender.png"
...
SWEP.Primary.Sound = {"weapons/arccw/g2contender/scout-1.wav", 80, 100, 75}
SWEP.Primary.Wait = 0
SWEP.OpenBolt = true
SWEP.WorldModelFake = "models/weapons/arccw/c_contender.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-6, 1.56, 2)
...
SWEP.cameraShakeMul = 0.50

SWEP.LocalMuzzlePos = Vector(18.893,-1.4,0.9)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-26, -1.5, 1.9)
...
SWEP.availableAttachments = {
	sight = {
		...
		["mount"] = {picatinny = Vector(10, 1.4, 0.05)}
	},
	barrel = {
		[1] = {"supressor7", Vector(-5, 0, 0), {}},
	    ["mount"] = Vector(27,0.8,0),
	},
}
--local to head
