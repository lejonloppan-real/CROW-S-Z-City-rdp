...
SWEP.PrintName = "Bullpup AK-74M"
SWEP.Author = "Izhevsk Machine-Building Plant"
SWEP.Instructions = "БРУХ ЭТО ЧТО НАХУЙ"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/akpack/w_ak74.mdl"
SWEP.WorldModelFake = "models/weapons/fml/rifle/c_ak74m_lol.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.LocalMuzzlePos = Vector(16,-0.25,3)
