...
SWEP.PrintName = "M500"
SWEP.Author = "Mossberg"
SWEP.Instructions = "Каратель спасибо!\n\nЗа что?\n\nЗа то что жизнь мне спас\n\nАда"
...
SWEP.LocalMuzzlePos = Vector(22,0.5,0.8)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-3, 0.5, 3)
SWEP.RHandPos = Vector(0, 0, -1)
SWEP.LHandPos = Vector(7, 0, -2)
SWEP.Ergonomics = 0.9
SWEP.Penetration = 7
SWEP.WorldPos = Vector(5, -1, -3)
