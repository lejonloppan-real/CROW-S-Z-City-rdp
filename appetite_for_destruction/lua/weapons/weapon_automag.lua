...
SWEP.PrintName = ".44 Auto Mag"
SWEP.Author = "Auto Mag Corporation"
SWEP.Instructions = "Pistol chambered in .44 AMP"
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tacint_extras/w_automag.mdl"
SWEP.WorldModelFake = "models/weapons/tacint_extras/v_automag.mdl"
SWEP.FakeAttachment = "1"
SWEP.FakePos = Vector(-18, 2.55, 1)
...
SWEP.FakeReloadSounds = {
	[0.15] = "tacint_extras/automag/slide_back.wav",
	...
	[0.93] = "tacint_extras/automag/slide_shut.wav",
}
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.41] = "weapons/universal/uni_crawl_l_05.wav",
	[0.6] = "weapons/arccw_ur/deagle/magin.ogg",
	[0.99] = "tacint_extras/automag/slide_shut.wav",
}
...
SWEP.WepSelectIcon2 = Material("entities/tacrp_io_automag.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/tacrp_io_automag.png"
...
SWEP.LocalMuzzlePos = Vector(6,-0.9,3.7)
...
SWEP.Primary.Ammo = ".44 AMP"
SWEP.Primary.Cone = 0
SWEP.Primary.Damage = 40
SWEP.Primary.Sound = {"tacint_extras/automag/deagle-1.wav", 75, 60, 70}
...
SWEP.ZoomPos = Vector(-30, -0.9, 4.8)
...
SWEP.shouldntDrawHolstered = true -- вау это же прям как в том фильме где нигер угражает нигеру ядерной боегловкой
