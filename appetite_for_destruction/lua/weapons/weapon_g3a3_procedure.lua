...
SWEP.PrintName = "G3A3"
SWEP.Author = "Я из германии прибыть сироп лечебный привозить от кашля помогать лечить"
SWEP.Instructions = "фар край 2"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/tfa_ins2_wpns/g3a3/w_fal.mdl"

SWEP.WepSelectIcon2 = Material("vgui/tfa_ins2_wpns_icons/tfa_ins2_wpn_g3a3")
SWEP.IconOverride = "vgui/tfa_ins2_wpns_icons/tfa_ins2_wpn_g3a3"
SWEP.weight = 4
...
SWEP.Primary.Sound = {"tfa_ins2_wpns/tfa_ins2_g3a3/fire.wav", 85, 80, 90}
...
SWEP.ReloadSoundes = {
	"none",
	"none",
	"tfa_ins2_wpns/tfa_ins2_g3a3/magout.wav",
	"none",
	"none",
	"tfa_ins2_wpns/tfa_ins2_g3a3/magin.wav",
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(29,0,3.2)
...
SWEP.availableAttachments = {
	sight = {
		...
		["mount"] = {["picatinny"] = Vector(-28, 3.1, 0.060)},
	},
	mount = {
		["picatinny"] = {
			"mount3",
