...
SWEP.PrintName = "MP40"
SWEP.Author = ""
SWEP.Instructions = "The MP40 is a German submachine gun used during World War II. Known for its compact design and controllable rate of fire, it was favored by paratroopers and infantry alike. Reliable and iconic, it became one of the most recognizable weapons of the era."
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/tfa_ins2_wpns/steyrmp40/w_mp40.mdl"
SWEP.WorldModelFake = "models/tfa_ins2_wpns/steyrmp40/v_mp40.mdl"
//SWEP.FakeScale = 1.2
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"TFA_INS2_STEYRMP40.Fire", 75, 120, 130}
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-3, 0.55, 5.0211)
