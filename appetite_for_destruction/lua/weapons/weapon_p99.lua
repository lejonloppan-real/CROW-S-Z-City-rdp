...
SWEP.Author = "Walther"
SWEP.Instructions = "Pistol chambered in 9x19mm \n\nKill them."
...
SWEP.Primary.Sound = {"m9/m9_tp.wav", 75, 85, 100}
SWEP.SupressedSound = {"m9/m9_suppressed_fp.wav", 55, 85, 100}
SWEP.Primary.SoundEmpty = {"zcitysnd/sound/weapons/makarov/handling/makarov_empty.wav", 75, 100, 105, CHAN_WEAPON, 2}
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor4", Vector(1,0,0), {}},
