...
SWEP.PrintName = "Calico M960"
SWEP.Author = "	Calico Light Weapons Systems"
...
SWEP.WorldModelFake = "models/weapons/tacint_shark/v_m950a.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-20, 2.5, 4)
SWEP.FakeAng = Angle(0.5, -0.4, 0)
...
SWEP.MagModel = "models/weapons/tacint_shark/magazines/m950a.mdl" 
...
SWEP.WepSelectIcon2 = Material("entities/tacrp_eo_calico.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/tacrp_eo_calico.png"

SWEP.CustomShell = "9x19"
SWEP.EjectPos = Vector(5,20,2)
SWEP.EjectAng = Angle(0,260,0)

SWEP.LocalMuzzlePos = Vector(11,-1.3,4.5)
SWEP.LocalMuzzleAng = Angle(0,-0.7,0)
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"tacint_shark/weapons/m950/m950_unsil.wav", 75, 120, 130}
...
SWEP.Spray = {}
for i = 1, 30 do
	SWEP.Spray[i] = Angle(-0.01 - math.cos(i) * 0.01, math.cos(i * i) * 0.01, 0) * 1
end
