...
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_waw_tommy_reg.mdl"

SWEP.WepSelectIcon2 = Material("entities/robotnik_waw_tom.png")
SWEP.IconOverride = "entities/robotnik_waw_tom.png"
SWEP.weight = 3.6
...
SWEP.LocalMuzzlePos = Vector(23,0,4)
