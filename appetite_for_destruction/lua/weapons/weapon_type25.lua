...
SWEP.Author = "Chinese Army"
SWEP.Instructions = "+100000 SOCIAL CREDIT! 这个星球上最酷，最受尊敬的机枪，它装载了5.8x42mm口径，尊重那些使用它的人和那些不使用它的人脚手架"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_bo2_type25.mdl"
SWEP.weaponInvCategory = 1
SWEP.CustomEjectAngle = Angle(0, 0, 90)
SWEP.Primary.ClipSize = 20
SWEP.Primary.DefaultClip = 20
SWEP.Primary.Automatic = true
SWEP.Primary.Ammo = "5.8×42 mm"
...
SWEP.Primary.Sound = {"weapons/bo2_type25.wav", 85, 100, 110}
...
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/tfa_ins2/famas/famas_magout.wav",
	"none",
	"weapons/tfa_ins2/famas/famas_magin.wav",
...
SWEP.WepSelectIcon2 = Material("entities/mac_bo2_type25.png")
SWEP.IconOverride = "entities/mac_bo2_type25.png"

SWEP.Ergonomics = 1
SWEP.WorldPos = Vector(-7, -1, -2)
