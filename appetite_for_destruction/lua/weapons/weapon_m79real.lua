...
SWEP.Instructions = "Single-shot, shoulder-fired, break-action grenade launcher that fires a Grenade 30x29mm"
SWEP.Category = "Weapons - Grenade Launchers"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_mp5_sef.mdl"
SWEP.WorldModelFake = "models/weapons/c_iw4_thumper.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.Primary.Sound = {"weapons/iw4/m79/fire.wav", 75, 90, 100}
...
SWEP.LocalMuzzleAng = Angle(8,-1,0)
