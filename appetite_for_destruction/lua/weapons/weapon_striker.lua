...
SWEP.Author = "The Sentinel Arms"
SWEP.Instructions = "Chambered in 12/70"
SWEP.Category = "Weapons - Shotguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_iw4_striker.mdl"

SWEP.WepSelectIcon2 = Material("vgui/hud/iw4_striker")
SWEP.IconOverride = "vgui/hud/iw4_striker"

SWEP.CustomShell = "12x70"
--SWEP.EjectPos = Vector(0,-15,0)
SWEP.EjectAng = Angle(0,-2,0)

SWEP.LocalMuzzlePos = Vector(27,0,3.2)
SWEP.LocalMuzzleAng = Angle(0.3,0,0)
SWEP.WeaponEyeAngles = Angle(-0.7,0,0)
SWEP.ReloadSound = "weapons/iw4/striker/insert.wav"
...
SWEP.Primary.Sound = {"weapons/iw4/striker/fire.wav", 80, 90, 100}
SWEP.SupressedSound = {"weapons/tfa_ins2/m500/m500_suppressed_fp.wav", 65, 90, 100}
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-3, 0, 7)
SWEP.RHandPos = Vector(0, 0, -1)
SWEP.LHandPos = Vector(7, 0, -2)
SWEP.Ergonomics = 0.9
SWEP.Penetration = 7
SWEP.WorldPos = Vector(0, -1, 0)
...
--local to head
SWEP.RHPos = Vector(3,-8,4)
SWEP.RHAng = Angle(0,-15,90)
--local to rh
SWEP.LHPos = Vector(0,-2,-3)
SWEP.LHAng = Angle(0,0,-90)
...
function SWEP:AnimationPost()
	...
	if CLIENT and IsValid(wep) then
		wep:ManipulateBonePosition(1,Vector(0,sin * 5,0),false)
	end
end
