...
SWEP.Instructions = "The PP-2000 (Russian: ПП-2000) is a submachine gun made by the KBP Instrument Design Bureau."
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_iw4_pp2000.mdl"
SWEP.punchmul = 1.5
SWEP.punchspeed = 3
SWEP.WepSelectIcon2 = Material("vgui/hud/iw4_pp2000")
SWEP.IconOverride = "vgui/hud/iw4_pp2000"
SWEP.weight = 1.5
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/iw4/pp2000/fire.wav", 75, 120, 130}
SWEP.Primary.Wait = 0.1
SWEP.ReloadTime = 4.2
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/iw4/pp2000/in.wav",
	"none",
	"none",
	"weapons/iw4/pp2000/in.wav",
	"none",
	"none",
	"weapons/iw4/pp2000/chamber.wav",
	"none",
	"none",
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(13,-0,1.7)
