...
SWEP.WorldModelFake = "models/weapons/arc9_doi/c_sten_mk2.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.LocalMuzzlePos = Vector(14.706,-1,2.9)
