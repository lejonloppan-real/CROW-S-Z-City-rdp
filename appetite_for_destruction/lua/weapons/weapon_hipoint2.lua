-- "addons\\homigrad-weapons\\lua\\weapons\\weapon_ruger.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
SWEP.Base = "homigrad_base"
SWEP.Spawnable = true
SWEP.AdminOnly = false
SWEP.PrintName = " Hi-Point 995"
SWEP.Author = "Hi-Point"
SWEP.Instructions = "ебанный 99 год"
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2  ---Vector( 20.33, -2.78, -0.6 )
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/akpack/w_ak74.mdl"
SWEP.WorldModelFake = "models/weapons/tacint/v_hipoint.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-19, 4, 2)
SWEP.FakeAng = Angle(0, 0, 0.1)
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.ZoomPos = Vector(0, 0.8, 6)
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.22] = "weapons/universal/uni_crawl_l_03.wav",
	[0.34] = "weapons/rifle_ruger1022/ruger_clipout.wav",
	[0.60] = "weapons/rifle_ruger1022/ruger_clipin.wav",
    [0.78] = "weapons/arccw_ud/m16/grab.ogg",
	--[0.75] = "weapons/universal/uni_crawl_l_05.wav",
	--[0.95] = "weapons/ak74/ak74_boltback.wav",
	[0.85] = "weapons/rifle_ruger1022/ruger_slidelock.wav",
...
SWEP.Primary.Sound = {"tacint_extras/hipoint/wpn_chinesepistolfire.wav", 75, 120, 140}
...
SWEP.LocalMuzzlePos = Vector(18,0.5,4)
