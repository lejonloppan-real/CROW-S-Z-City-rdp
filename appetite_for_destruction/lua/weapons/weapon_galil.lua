...
SWEP.Author = "ЕВРЕИ"
SWEP.Instructions = "галилы это если шо деньги такие"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_bo1_galil.mdl"
...
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/robotnik_bo1_galil/out.wav",
	"none",
	"none",
	"weapons/robotnik_bo1_galil/in1.wav",
	"none",
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(27,-0.3,4.6)
SWEP.LocalMuzzleAng = Angle(0,-1.5,0)
