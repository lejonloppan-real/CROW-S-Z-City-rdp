...
SWEP.Author = "Walther"
SWEP.Instructions = "Холодные войны "
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_bo1_mpl.mdl"
SWEP.punchmul = 1.5
SWEP.punchspeed = 3
SWEP.WepSelectIcon2 = Material("entities/robotnik_bo1_mpl.png")
SWEP.IconOverride = "entities/robotnik_bo1_mpl.png"
SWEP.weight = 1.5
