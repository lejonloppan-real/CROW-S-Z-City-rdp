...
SWEP.Instructions = "FN Five-seveN is a single-action, semi-automatic pistol chambered in 5,7 × 28 мм."
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_bo2_57.mdl"

SWEP.WepSelectIcon2 = Material("vgui/tfa_ins2_wpns_icons/tfa_ins2_wpn_m1911colt")
SWEP.IconOverride = "vgui/tfa_ins2_wpns_icons/tfa_ins2_wpn_m1911colt"

SWEP.CustomShell = "556x45"
SWEP.EjectPos = Vector(0,24,2)
...
SWEP.Primary.Sound = {"weapons/bo2_57.wav", 75, 90, 100}
SWEP.SupressedSound = {"weapons/tfa_ins2/usp_tactical/fp_suppressed1.wav", 55, 90, 100}
SWEP.Primary.SoundEmpty = {"tfa_ins2_wpns/tfa_ins2_m1911colt/empty.wav", 75, 100, 105, CHAN_WEAPON, 2}
SWEP.Primary.Force = 30
SWEP.Primary.Wait = PISTOLS_WAIT
SWEP.ReloadTime = 4
SWEP.ReloadSoundes = {
	"none",
	"tfa_ins2_wpns/tfa_ins2_m1911colt/magout.wav",
	"tfa_ins2_wpns/tfa_ins2_m1911colt/magin.wav",
	"tfa_ins2_wpns/tfa_ins2_m1911colt/boltrelease.wav",
	"none",
	"none"
}
...
SWEP.ZoomPos = Vector(0, -0.019, 3.5)
SWEP.SprayRand = {Angle(-0.03, -0.03, 0), Angle(-0.05, 0.03, 0)}
SWEP.Ergonomics = 1
SWEP.Penetration = 9
SWEP.WorldPos = Vector(-19, -1.3, -2)
