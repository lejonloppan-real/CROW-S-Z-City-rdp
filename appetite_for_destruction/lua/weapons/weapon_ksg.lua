...
SWEP.PrintName = "KSG"
SWEP.Author = "Kel-Tec"
SWEP.Instructions = "Pump-action shotgun chambered in 12/70 caliber. ПАЦАНЫ ДРОБОВИК ДЖОНА УИКА"
SWEP.Category = "Weapons - Shotguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/w_ksg.mdl"
SWEP.WorldModelFake = "models/weapons/tfa_ins2/c_ksg.mdl" -- ОЧЕНЬ странная проблема с модельками глеба, работать начинают только если ты включишь камеру на игрока, возможно проблема в рендероверайде...
//SWEP.FakeScale = 1.5
...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_ksg")
SWEP.IconOverride = "vgui/hud/tfa_ins2_ksg"

SWEP.LocalMuzzlePos = Vector(20,0.7,5.098)
...
SWEP.ReloadSound = "weapons/tfa_ins2/ksg/insertshell-1.wav"
...
SWEP.Primary.Sound = {"weapons/tfa_ins2/ksg/toz_fp.wav", 80, 90, 100}
