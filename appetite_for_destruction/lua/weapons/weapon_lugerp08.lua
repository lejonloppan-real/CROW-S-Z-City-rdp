...
SWEP.PrintName = "Luger P-08"
SWEP.Author = "Немцы"
SWEP.Instructions = "Зарядить и стрелять в евреев"
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_doi/w_doi_lugerp08.mdl"
...
SWEP.ZoomPos = Vector(0, -2, -1)
SWEP.SprayRand = {Angle(-0.03, -0.03, 0), Angle(-0.05, 0.03, 0)}
SWEP.Ergonomics = 1
SWEP.Penetration = 9
SWEP.WorldPos = Vector(-12, -3, -5)
SWEP.WorldAng = Angle(0, 0, 0)

SWEP.LocalMuzzlePos = Vector(19,-2,-1.5)
