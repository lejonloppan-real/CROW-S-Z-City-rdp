...
SWEP.Author = "	Franchi S.p.A."
SWEP.Instructions = "ANAPA APPROVED"
SWEP.Category = "Weapons - Shotguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tacint_shark/w_spas15.mdl"
SWEP.WorldModelFake = "models/weapons/tacint_shark/v_spas15.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-15, 3, 7)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(8,-6.5,3.7)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "00900080302"
SWEP.ZoomPos = Vector(0, -1.1, 5.9)
...
SWEP.FakeEmptyReloadSounds = {
	...
	--[0.95] = "weapons/ak74/ak74_boltback.wav",
	[0.83] = "weapons/usas_bolt.wav",
	[0.90] = "weapons/ak74/ak74_boltrelease.wav",
	[1.01] = "weapons/universal/uni_crawl_l_04.wav",
}

SWEP.MagModel = "models/bhl/weapons/magazines/w_usas12_mag.mdl"
...
SWEP.Primary.Sound = {"tacint_shark/weapons/spas15/fire1_old.wav", 75, 120, 140}
SWEP.Primary.SoundEmpty = {"weapons/usas_dryfire.wav", 75, 100, 105, CHAN_WEAPON, 2}
SWEP.Primary.Wait = 0.400
SWEP.ReloadTime = 5.5
SWEP.ReloadSoundes = {
	"none",
	"none",
	"tacint_shark/weapons/spas15/clipout.wav",
	"none",
	"tacint_shark/weapons/spas15/clipin.wav",
...
SWEP.LocalMuzzlePos = Vector(22,-1,2.7)
...
SWEP.WepSelectIcon2 = Material("entities/arc9_bhl_usas12.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/arc9_bhl_usas12.png"
...
SWEP.availableAttachments = {
	sight = {
		...
		["mount"] = {["dovetail"] = Vector(-30, 6.02, 0),["picatinny"] = Vector(-30, 6.02, -0.100)},
	},
	mount = {
		["picatinny"] = {
			"mount3",
