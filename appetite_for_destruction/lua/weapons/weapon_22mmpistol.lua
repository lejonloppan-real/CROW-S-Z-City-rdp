...
SWEP.WorldModelFake = "models/weapons/pistols/v_tfa_falloutgunz_silenced22pistol.mdl" --https://steamcommunity.com/sharedfiles/filedetails/?id=3544105055
...
SWEP.WepSelectIcon2 = Material("vgui/entities/tfa_falloutgunz_22silencedpistol")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "vgui/entities/tfa_falloutgunz_22silencedpistol"
...
SWEP.Primary.Sound = {"weapons/waw_tokarev/fire.wav", 75, 90, 100}
SWEP.SupressedSound = {"gunz/silencedpistol22/fire_silenced.wav", 55, 90, 100}
SWEP.Primary.SoundEmpty = {"gunz/10mmpistol/hammer.wav", 75, 100, 105, CHAN_WEAPON, 2}
...
SWEP.LocalMuzzlePos = Vector(11,1.5,3.8)
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(7,Vector(-1.4*self.shooanim ,0 ,0 ),false)
	end
end
