...
SWEP.Author = "3 патронный"
SWEP.Instructions = "Я заебался писать название этого оружия"
SWEP.Category = "Weapons - Shotguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/w_models/w_shorty.mdl"

SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_ins2_m500")
SWEP.IconOverride = "vgui/hud/tfa_ins2_m500"

SWEP.CustomShell = "12x70"
--SWEP.EjectPos = Vector(0,-15,0)
SWEP.EjectAng = Angle(0,-2,0)

SWEP.LocalMuzzlePos = Vector(19,0,5)
SWEP.LocalMuzzleAng = Angle(0.3,0,0)
SWEP.WeaponEyeAngles = Angle(-0.7,0,0)
SWEP.ReloadSound = "weapons/tfa_ins2/m500/m500_single_shell_insert_1.wav"
...
SWEP.Primary.Sound = {"weapons/tfa_ins2/m500/m500_fp.wav", 80, 90, 100}
