...
SWEP.Author = "Русские"
SWEP.Instructions = "НАХУЙ ИЗ СТАЛИНГРАДА!"
SWEP.Category = "Weapons - Machineguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/dp28/w_wrb_dp28.mdl"
SWEP.WorldModelFake = "models/weapons/dp28/c_wrb_dp28.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(0, -1, 5.55)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "00300051022"
SWEP.ZoomPos = Vector(0, -0.890, 5)
...
SWEP.FakeReloadSounds = {
	...
	[0.34] = "weapons/dp28/reolads/out.wav",
	--[0.38] = "weapons/ak74/ak74_magout_rattle.wav",
	--[0.51] = "weapons/universal/uni_crawl_l_02.wav",
	[0.80] = "weapons/dp28/reolads/in.wav",
	[0.90] = "weapons/dp28/reolads/hit.wav",
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.62] = "weapons/dp28/reolads/in.wav",
	[0.70] = "weapons/dp28/reolads/hit.wav",
	--[0.75] = "weapons/universal/uni_crawl_l_05.wav",
	--[0.95] = "weapons/ak74/ak74_boltback.wav",
	[0.90] = "weapons/dp28/reolads/pull.wav",
	[1.01] = "weapons/universal/uni_crawl_l_04.wav",
}

SWEP.MagModel = "models/weapons/dp28/dp28_magazin.mdl"
...
SWEP.Primary.Sound = {"weapons/dp28/fire/dp28_cooldown.mp3", 75, 120, 140}
...
SWEP.LocalMuzzlePos = Vector(27.985,-0.5,3.6)
...
SWEP.WepSelectIcon2 = Material("vgui/entities/tfa_cod2_dp28")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "vgui/entities/tfa_cod2_dp28"
