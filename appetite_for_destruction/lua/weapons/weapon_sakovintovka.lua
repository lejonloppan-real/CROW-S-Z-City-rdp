...
SWEP.WepSelectIcon2 = Material("vgui/hud/tfa_nmrih_sn_sako")
SWEP.IconOverride = "vgui/hud/tfa_nmrih_sn_sako"
...
SWEP.LocalMuzzlePos = Vector(34,0.19,2)
