...
SWEP.Instructions = "GOING POSTAL "
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/boyz/w_m3.mdl"
SWEP.punchmul = 1.5
SWEP.punchspeed = 3
SWEP.WepSelectIcon2 = Material("entities/tfa_at_m3_boyz.png")
SWEP.IconOverride = "entities/tfa_at_m3_boyz.png"
SWEP.weight = 1.5
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/m3_boyz/fire.wav", 75, 120, 130}
SWEP.Primary.Wait = 0.1
SWEP.ReloadTime = 4.2
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/m3_boyz/magout.wav",
	"none",
	"none",
	"weapons/m3_boyz/magin.wav",
	"none",
	"none",
	"weapons/m3_boyz/boltback.wav",
...
SWEP.LocalMuzzlePos = Vector(15.006,0,3.5)
