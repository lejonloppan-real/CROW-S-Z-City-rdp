...
SWEP.PrintName = "C96"
SWEP.Author = "МАУЗЕР"
SWEP.Instructions = "СЕЛФИ ОТ НИКОЛАЯ ВТОРОГО"
...
SWEP.WepSelectIcon2 = Material("entities/p08.png")
SWEP.IconOverride = "entities/p08.png"
...
SWEP.Primary.Ammo = "7.63x25 mm Mauser"
SWEP.Primary.Cone = 0
SWEP.Primary.Damage = 30
SWEP.Primary.Sound = {"weapons/tfa_nam_c96/c96_4.wav", 75, 90, 100}
SWEP.SupressedSound = {"weapons/tfa_ins2/usp_tactical/fp_suppressed1.wav", 55, 90, 100}
SWEP.Primary.SoundEmpty = {"weapons/c96/handling/c96_empty.wav", 75, 100, 105, CHAN_WEAPON, 2}
SWEP.Primary.Force = 30
SWEP.Primary.Wait = PISTOLS_WAIT
SWEP.ReloadTime = 4
SWEP.ReloadSoundes = {
	"none",
	"weapons/c96/handling/c96_strippr_clip_in.wav",
	"weapons/c96/handling/c96_strippr_clip_rounds_in_02.wav",
	"weapons/c96/handling/c96_boltback.wav",
	"weapons/c96/handling/c96_boltrelease.wav",
	"none"
}
SWEP.DeploySnd = {"homigrad/weapons/draw_pistol.mp3", 55, 100, 110}
SWEP.HolsterSnd = {"homigrad/weapons/holster_pistol.mp3", 55, 100, 110}
SWEP.HoldType = "revolver"
SWEP.ZoomPos = Vector(0, 0, 2.5)
SWEP.SprayRand = {Angle(-0.03, -0.03, 0), Angle(-0.05, 0.03, 0)}
SWEP.Ergonomics = 1
SWEP.Penetration = 12
SWEP.WorldPos = Vector(3, -1, -4)
SWEP.WorldAng = Angle(0, 0, 0)

SWEP.LocalMuzzlePos = Vector(14,0,1)
