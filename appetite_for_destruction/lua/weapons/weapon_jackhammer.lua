...
SWEP.Author = "Pancor"
SWEP.Instructions = "ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ ЕГО НЕ СУЩЕСТВУЕТ"
SWEP.Category = "Weapons - Shotguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tacint_shark/w_jackhammer.mdl"
SWEP.WorldModelFake = "models/weapons/tacint_shark/v_jackhammer.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-12, 4, 1)
...
SWEP.FakeReloadSounds = {
	...
	[0.34] = "tacint_shark/jackhammer/clipout.mp3",
	[0.4] = "weapons/ak74/ak74_magout_rattle.wav",
	[0.62] = "tacint_shark/jackhammer/magtap.mp3",
...
SWEP.FakeEmptyReloadSounds = {
	...
	--[0.95] = "weapons/ak74/ak74_boltback.wav",
	[0.83] = "tacint_shark/jackhammer/xm1014_boltforward.wav",
	[0.86] = "tacint_shark/jackhammer/xm1014_boltback.wav",
	[1.01] = "weapons/universal/uni_crawl_l_04.wav",
}

SWEP.MagModel = "models/weapons/tacint_shark/magazines/jackhammer.mdl" 
...
SWEP.Primary.Sound = {"tacint_shark/jackhammer/xm1014-1.wav", 85, 90, 100}
...
SWEP.LocalMuzzlePos = Vector(20,0.5,2.741)
