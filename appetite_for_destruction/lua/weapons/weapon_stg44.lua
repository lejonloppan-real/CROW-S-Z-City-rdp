...
SWEP.Author = "Немцы"
SWEP.Instructions = "Гитлер говорил не нравится ему такое, а его послали нахуй."
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/stg44/w_cod1_mp44.mdl"
SWEP.WorldModelFake = "models/weapons/stg44/v_cod1_mp44.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-1, -1.100, 5.3)
SWEP.FakeAng = Angle(-1, 0.3, 5.5)
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "00900080302"
SWEP.ZoomPos = Vector(0, -0.900, 6.100)
...
SWEP.FakeReloadSounds = {
	...
	[0.34] = "weapons/stg44/reolads/out.wav",
	--[0.38] = "weapons/ak74/ak74_magout_rattle.wav",
	--[0.51] = "weapons/universal/uni_crawl_l_02.wav",
	[0.70] = "weapons/stg44/reolads/in1.wav",
	[0.75] = "weapons/stg44/reolads/in2.wav",
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.22] = "weapons/universal/uni_crawl_l_03.wav",
	[0.30] = "weapons/stg44/reolads/out.wav",
	--[0.4] = "weapons/ak74/ak74_magout_rattle.wav",
	[0.60] = "weapons/stg44/reolads/in1.wav",
	[0.65] = "weapons/stg44/reolads/in2.wav",
	--[0.75] = "weapons/universal/uni_crawl_l_05.wav",
	--[0.95] = "weapons/ak74/ak74_boltback.wav",
	[0.83] = "weapons/stg44/reolads/pull.wav",
...
SWEP.Primary.Sound = {"weapons/stg44/fire/mp44_01_distant.mp3", 75, 120, 140}
...
SWEP.LocalMuzzlePos = Vector(22,-0.30,4)
...
SWEP.WepSelectIcon2 = Material("vgui/entities/cod_stg44")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "vgui/entities/cod_stg44"
