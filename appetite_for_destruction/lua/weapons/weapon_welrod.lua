...
SWEP.Instructions = "Stealth boy. 9X19"
...
SWEP.IconOverride = "entities/arccw_welrod.png"
...
SWEP.Primary.Sound = {"zcitysnd/sound/weapons/makarov/makarov_suppressed_tp.wav", 65, 90, 100}
...
SWEP.ZoomPos = Vector(-26, -0.0054, 7.2)
SWEP.SprayRand = {Angle(-0.03, -0.03, 0), Angle(-0.05, 0.03, 0)}
SWEP.Ergonomics = 1.2
SWEP.Penetration = 4
SWEP.WorldPos = Vector(12, -1.5, 1.5)
SWEP.WorldAng = Angle(0, 0, 0)

SWEP.LocalMuzzlePos = Vector(4,0,6.2)
...
function SWEP:AnimationPost()
	...
	local wep = self:GetWeaponEntity()
	if CLIENT and IsValid(wep) then
		wep:ManipulateBonePosition(1, Vector(0, 0, -3 * self.sin), false)
