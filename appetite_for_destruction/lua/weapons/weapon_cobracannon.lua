...
SWEP.PrintName = "Cobra Assault Cannon"
SWEP.Author = "OCP"
SWEP.Instructions = "Semi-automatic Marksman rifle from future chambered in Explosive 50 .BMG"
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_sr25_gleb.mdl"
SWEP.WorldModelFake = "models/weapons/arccw/c_rbc_gear_c_002.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.Primary.Ammo = "Explosive .50 BMG"
SWEP.OpenBolt = true
SWEP.CustomShell = ""
...
SWEP.Primary.Sound = {"mk11bfg/shot01.ogg", 75, 90, 100}
SWEP.Primary.SoundEmpty = {"zcitysnd/sound/weapons/ak74/handling/ak74_empty.wav", 75, 100, 105, CHAN_WEAPON, 2}
SWEP.Primary.Wait = 2
SWEP.ReloadTime = 5


SWEP.PPSMuzzleEffect = "" -- shared in sh_effects.lua

SWEP.LocalMuzzlePos = Vector(9,-0.25,3.3)
...
SWEP.availableAttachments = {
	sight = {
		...
		["mount"] = {picatinny = Vector(-54, 1.8, -0.8)}
	},
}
...
SWEP.WepSelectIcon2 = Material("entities/sh_wiashbringer.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/sh_wiashbringer.png"
