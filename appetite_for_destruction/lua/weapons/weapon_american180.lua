...
SWEP.Author = "Voere"
SWEP.Instructions = "Submachine gun chambered in .22 LR"
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_mp5_sef.mdl"
SWEP.WorldModelFake = "models/weapons/smgs/v_tfa_falloutgunz_22smg.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.WepSelectIcon2 = Material("vgui/entities/tfa_falloutgunz_22smg")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "vgui/entities/tfa_falloutgunz_22smg"

SWEP.CustomShell = "9x19"
--SWEP.EjectPos = Vector(0,-20,5)
--SWEP.EjectAng = Angle(0,90,0)

SWEP.LocalMuzzlePos = Vector(27,-1.3,2.5)
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"gunz/22smg/fire_fp.wav", 75, 120, 130}
