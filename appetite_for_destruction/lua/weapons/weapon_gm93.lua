...
SWEP.PrintName = "GM93"
SWEP.Author = "МВД"
SWEP.Instructions = "ЧАЙНАЛЕЙК 2: ПРИКЛЮЧЕНИЯ В РОССИИ"
SWEP.Category = "Weapons - Grenade Launchers"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/comrade/w_gm.mdl"

SWEP.WepSelectIcon2 = Material("entities/arccw_bo1_chinalake.png")
SWEP.IconOverride = "entities/arccw_bo1_chinalake.png"
...
SWEP.LocalMuzzlePos = Vector(20,-0.003,5)
