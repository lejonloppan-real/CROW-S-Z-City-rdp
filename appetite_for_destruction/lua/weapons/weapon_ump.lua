...
SWEP.Instructions = "The Heckler & Koch UMP is a submachine gun developed and manufactured by Heckler & Koch."
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_iw4_ump45.mdl"
...
SWEP.Primary.Sound = {"weapons/iw4/ump45/fire.wav", 85, 80, 90}
SWEP.Primary.Wait = 0.07
SWEP.ReloadTime = 5.7
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/iw4/ump45/out.wav",
	"none",
	"none",
	"weapons/iw4/ump45/in.wav",
	"none",
	"none",
	"none",
	"none",
	"weapons/iw4/ump45/chamber.wav",
	"none",
	"none",
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector (19,-0.005,3.5)
...
SWEP.availableAttachments = {
	sight = {
		["mountType"] = "picatinny",
		["mount"] = Vector(-11, 0.6, 2.5),
		["mountAngle"] = Angle(0,0,90),
	},
		grip = {
		["mount"] = Vector(12,1.5,-1),
		["mountType"] = "picatinny",
		["mountAngle"] = Angle(0,0,90),
	},
	 underbarrel = {
		["mount"] = {["picatinny_small"] = Vector(10,-1.2,-0.2),["picatinny"] = Vector(13,-1.2,0.5)},
		["mountAngle"] = {["picatinny_small"] = Angle(0, 0, 180),["picatinny"] = Angle(0, 0, 180)},
