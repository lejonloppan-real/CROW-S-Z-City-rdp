...
SWEP.Primary.Sound = {"weapons/waw_bar/fire.wav", 85, 80, 90}
...
SWEP.Primary.Wait = 0.130
SWEP.ReloadTime = 5.7
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/waw_bar/out.wav",
	"none",
	"none",
	"weapons/waw_bar/in1.wav",
	"none",
	"none",
	"none",
...
SWEP.LocalMuzzlePos = Vector(39,0,3.9)
