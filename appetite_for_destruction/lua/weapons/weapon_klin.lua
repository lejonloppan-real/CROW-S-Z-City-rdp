...
SWEP.PrintName = "Klin"
SWEP.Author = "Драгунов"
SWEP.Instructions = "сталкер тень хз кого там мод"
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/comrade/w_klin2.mdl"

SWEP.WepSelectIcon2 = Material("scrappers/ab-10.png")
SWEP.IconOverride = "vgui/entities/pm9_evil_gun"
...
SWEP.LocalMuzzlePos = Vector(8,0.15,4)
