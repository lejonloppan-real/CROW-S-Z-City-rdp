...
SWEP.PrintName = "AT4"
SWEP.Author = "Saab Bofors Dynamics"
SWEP.Instructions = "The AT4 is a portable unguided shoulder-launched anti-tank rocket launcher. Although the AT4 is disposable, this version is reusable."
...
SWEP.WepSelectIcon2 = Material("vgui/hud/iw4_at4")
SWEP.IconOverride = "vgui/hud/iw4_at4"
...
SWEP.Primary.Ammo = "AT4 Projectile"--rpg rounds
SWEP.Primary.Cone = 0
SWEP.Primary.Damage = 1
SWEP.Primary.Sound = {"weapons/iw4/at4/fire.wav", 75, 90, 100}
...
function SWEP:Shoot(override)
	...
	if SERVER then
		local projectile = ents.Create("at4_projectile")
		projectile.owner = self:GetOwner()
		projectile:SetPos(pos + ang:Right() * 0)
		...
		if IsValid(phys) then
			phys:SetVelocity(self:GetOwner():GetVelocity() + ang:Forward() * 400)
		end
...
-- Inspect Assault
SWEP.LocalMuzzlePos = Vector(20,-0.2,0)
