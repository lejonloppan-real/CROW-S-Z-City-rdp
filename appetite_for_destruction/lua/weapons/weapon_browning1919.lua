...
SWEP.Instructions = "Machine gun chambered in .30-06 Springfield"
SWEP.Category = "Weapons - Machineguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_waw_browningm1919.mdl"

SWEP.WepSelectIcon2 = Material("entities/robotnik_waw_bar.png")
SWEP.IconOverride = "entities/robotnik_waw_bar.png"
SWEP.weight = 8
SWEP.weaponInvCategory = 1
SWEP.Primary.ClipSize = 250
SWEP.Primary.DefaultClip = 250
SWEP.Primary.Automatic = true
SWEP.Primary.Ammo = ".30-06 Springfield"
SWEP.Primary.Cone = 0
SWEP.Primary.Damage = 60
SWEP.Primary.Spread = 0
SWEP.Primary.Force = 60
SWEP.ShockMultiplier = 5
SWEP.Primary.Sound = {"weapons/waw_m1919/fire.wav", 85, 80, 90}
...
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/waw_m1919/open.wav",
	"none",
	"none",
	"weapons/waw_m1919/addchain.wav",
	"weapons/waw_m1919/close.wav",
	"none",
	"none",
	"weapons/waw_m1919/pull.wav",
	"none",
	"weapons/waw_m1919/release.wav",
	"none",
	"none",
	"none",
	"none"
...
SWEP.LocalMuzzlePos = Vector(39,0.3,1.2)
