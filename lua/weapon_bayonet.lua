...
SWEP.Instructions = "A military-grade bayonet, designed to attach to a rifle or serve as a standalone blade.\n\nLMB to attack.\nR + LMB to change attack mode.\nRMB to block."
SWEP.Category = "Weapons - Melee"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.WorldModel = "models/octoteam/weapons/melee/w_knife_bayonet.mdl"
SWEP.WorldModelReal = "models/weapons/gleb/c_knife_t.mdl"
SWEP.WorldModelExchange = "models/octoteam/weapons/melee/w_knife_bayonet.mdl"
...
SWEP.weaponPos = Vector(-4.2,-1,1)
SWEP.weaponAng = Angle(155,-90,0)
