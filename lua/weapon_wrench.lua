...
SWEP.Instructions = "A versatile hand tool used for gripping and turning fasteners like nuts and bolts.\n\nLMB to attack.\nRMB to block.\nRMB + LMB to throw."
SWEP.Category = "Weapons - Melee"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.WorldModel = "models/octoteam/weapons/melee/w_me_wrench.mdl"
SWEP.WorldModelReal = "models/weapons/tfa_nmrih/v_me_pipe_lead.mdl"
SWEP.WorldModelExchange = "models/octoteam/weapons/melee/w_me_wrench.mdl"
SWEP.ViewModel = ""
...
SWEP.weaponPos = Vector(0,-1,-4.0)
SWEP.weaponAng = Angle(0,100,-100)
