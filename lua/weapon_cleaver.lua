...
SWEP.Instructions = "A heavy cleaver, built for chopping through meat and bone with force.\n\nLMB to attack.\nRMB to block.\nRMB + LMB to throw."
...
SWEP.WorldModel = "models/octoteam/weapons/melee/w_me_cleaver.mdl"
SWEP.WorldModelReal = "models/weapons/tfa_nmrih/v_me_hatchet.mdl"
SWEP.WorldModelExchange = "models/octoteam/weapons/melee/w_me_cleaver.mdl"
...
SWEP.weaponPos = Vector(-1.5,1.3,-1.9)
SWEP.weaponAng = Angle(0,-90,-80)
